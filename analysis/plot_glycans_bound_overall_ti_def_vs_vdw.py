...
axs[0].bar(r, bar_near_acc, color = 'lightgray',
            ...
            label='Near acceptable (3 $\mathrm{\AA}$ < IL-RMSD < 4 $\mathrm{\AA}$)')
axs[0].bar(r, bar_acc, color = '#a5cee2',
            width = width, edgecolor = 'black',
            label='Acceptable (2 $\mathrm{\AA}$ < IL-RMSD < 3 $\mathrm{\AA}$)')
axs[0].bar(r, bar_med, color = '#b2df8a',
        width = width, edgecolor = 'black',
            label='Medium (1 $\mathrm{\AA}$ < IL-RMSD < 2 $\mathrm{\AA}$)')
axs[0].bar(r, bar_high, color = '#33a02b',
        width = width, edgecolor = 'black',
            label='High (IL-RMSD < 1 $\mathrm{\AA}$)')
...
#plt.tight_layout()
plt.savefig("figures/bound_ti_overall_ti_def_vs_vdw.png", dpi=1200, bbox_inches="tight")
plt.close()
